...
#define cDEVICE_ID      { 0xF4, 0x02, 0x01 }    // 0xF4,0x01 = Gerätetyp (privater Bereich F4xx), 0x01 = Instanz Nr.1
#define cDEVICE_SERIAL  "HBAHTL1101"
...
#define SENSOR_AHT11     // I2C Sensor AHT11 (T/H)
#define SENSOR_LDR     // LDR (Lux)
...
//---------------------------------------------------------
// WeAct 1.54" 200x200 BW e-paper (SSD1681) pin definitions
// SPI data lines (MOSI=11, SCK=13) are shared with the CC1101 radio.
#define EPD_CS    9   // chip select
